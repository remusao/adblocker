...
µBlock.BidiTrieContainer = class {
    ...
    async enableWASM() {
        ...
        const module = await µBlock.STrieContainerReadyPromise;
...
µBlock.STrieContainerReadyPromise = (( ) => {
    if (
        typeof WebAssembly !== 'object' ||
        typeof WebAssembly.compile !== 'function'
    ) {
        return Promise.reject('No WebAssembly');
    }
    ...
    return WebAssembly.compile(
      fs.readFileSync(path.resolve(__dirname, './wasm/biditrie.wasm')),
    );
})();
